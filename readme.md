...
* **ctc forced alignment:** we utilized the [`mms-300m`](https://huggingface.co/facebook/mms-300m) aligner to extract precise start/end timestamps for every word in the training set. [see preprocessing notebook](https://github.com/ishmamzarif/dl-sprint-4.0/blob/main/labyrinth_dataset_preprocessing.ipynb)
...
* **inference:** batched asr inference utilizing [`silero-vad`](https://github.com/snakers4/silero-vad) **vad-aware chunking** to process test audio. [see asr inference notebook](https://github.com/ishmamzarif/dl-sprint-4.0/blob/main/labyrinth_asr_inference.ipynb)
